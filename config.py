...
def parse_args(ignore_unknown_args=False):
    ...
    parser.add_argument('--data-path', default='''/home/yunxshi/Data/cifar-10-python''', type=str, help='data path')
    parser.add_argument('--save-path', default='''/home/yunxshi/Data/workspace/DataPruning/TrainPhase_randomPruning_5000/''', type=str, help='model save path')
    ...
    parser.add_argument('--test-batch-size', default=500, type=int, help='test batch size')
